@rem ---------------------------------------------------------------------------
@rem Script used to build DelphiDabbler SITools UnInstall program.
@rem
@rem Copyright (C) Peter Johnson (www.delphidabbler.com), 2008
@rem
@rem v1.0 of 09 Feb 2008 - Original version.
@rem v1.1 of 11 Apr 2008 - Revised to compile new UIResources.rc resource file.
@rem ---------------------------------------------------------------------------
...
echo.
echo UnInstall: Building Resources
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

rem Version info resource: VUnInstall.vi
set VIBase=VUnInstall
...
echo.
echo UnInstall: Building Pascal Project
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.
