@rem ---------------------------------------------------------------------------
@rem Script used to build DelphiDabbler SITools BZDeflate library.
@rem
...
set SrcDir=.\
set BinDir=..\..\..\Bin\BZDeflate\
set DevTools=..\..\..\DevTools\
set Project=BZDeflate
...
echo.
echo BZDeflate: Building Resources
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

rem Version info resource: VBZDeflate.vi
set VIBase=VBZDeflate
...
echo.
echo BZDeflate: Building Pascal Project
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.
