@rem ---------------------------------------------------------------------------
@rem Script used to build DelphiDabbler SITools ZDeflate library.
@rem
...
set SrcDir=.\
set BinDir=..\..\..\Bin\ZDeflate\
set DevTools=..\..\..\DevTools\
set Project=ZDeflate
...
echo.
echo ZDeflate: Building Resources
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

rem Version info resource: VZDeflate.vi
set VIBase=VZDeflate
...
echo.
echo ZDeflate: Building Pascal Project
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.
