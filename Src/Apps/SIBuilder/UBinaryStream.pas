{ ##
  ...
  @COMMENTS                 This unit defines the UBinaryStream class. This
                            descendant of TDataStream implements methods that
                            read and write to/from binary representations of
                            integers strings using a wrapped TStream object for
                            i/o.
  @HISTORY(
    @REVISION(
      @VERSION              1.0
 ...
 * 
 * The Original Code is UBinaryStream.pas.
 * 
