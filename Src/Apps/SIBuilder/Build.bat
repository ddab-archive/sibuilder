@rem ---------------------------------------------------------------------------
@rem Script used to build DelphiDabbler SITools SIBuilder program.
@rem
...
set SrcDir=.\
set BinDir=..\..\..\Bin\SIBuilder\
set DevTools=..\..\..\DevTools\
set Project=SIBuilder
...
echo.
echo SIBuilder: Building Resources
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

rem Version info resource: VSIBuilder.vi
set VIBase=VSIBuilder
...
rem Resources file: Resources.rc
set RCBase=Resources
...
echo.
echo SIBuilder: Building Pascal Project
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

set PasBase=%Project%
set PasProj=%SrcDir%%PasBase%.dpr
set PasExe=%MainExeDir%%PasBase%.exe
set DDabLib=%DELPHIDABLIBD7%
set PkgBin=..\..\..\Bin\SIBCmp

echo Building %PasBase%.dpr
%DCC7% -B %PasProj% -U"%DDabLib%;%PkgBin%"
