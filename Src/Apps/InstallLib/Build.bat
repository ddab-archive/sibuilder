@rem ---------------------------------------------------------------------------
@rem Script used to build DelphiDabbler SITools InstallLib library.
@rem
...
set SrcDir=.\
set BinDir=..\..\..\Bin\InstallLib\
set DevTools=..\..\..\DevTools\
set Project=InstallLib
...
echo.
echo InstallLib: Building Resources
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

rem Version info resource: VInstallLib.vi
set VIBase=VInstallLib
...
echo.
echo InstallLib: Building Pascal Project
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.
