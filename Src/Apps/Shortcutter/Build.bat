@rem ---------------------------------------------------------------------------
@rem Script used to build DelphiDabbler SITools Shortcutter program.
@rem
@rem Copyright (C) Peter Johnson (www.delphidabbler.com), 2008
@rem
@rem v1.0 of 09 Feb 2008 - Original version.
@rem v1.1 of 11 Apr 2008 - Revised to compile new SResources.rc resource file.
@rem ---------------------------------------------------------------------------
...
set SrcDir=.\
set BinDir=..\..\..\Bin\Shortcutter\
set DevTools=..\..\..\DevTools\
set Project=Shortcutter
...
echo.
echo Shortcutter: Building Resources
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

rem Version info resource: VShortcutter.vi
set VIBase=VShortcutter
...
rem General resources: UIResources.rc
set RCBase=SResources
...
echo.
echo Shortcutter: Building Pascal Project
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.
