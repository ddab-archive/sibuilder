@rem ---------------------------------------------------------------------------
@rem Script used to build DelphiDabbler SITools RegCOMSvrs COM server library.
@rem
...
set SrcDir=.\
set BinDir=..\..\..\Bin\RegCOMSvrs\
set DevTools=..\..\..\DevTools\
set Project=RegCOMSvrs
...
echo.
echo RegCOMSvrs: Building Resources
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

rem Version info resource: VRegCOMSvrs.vi
set VIBase=VRegCOMSvrs
...
echo.
echo RegCOMSvrs: Building Pascal Project
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo.

set PasBase=%Project%
set PasProj=%SrcDir%%PasBase%.dpr
set PasExe=%XtraExeDir%%PasBase%.dll
